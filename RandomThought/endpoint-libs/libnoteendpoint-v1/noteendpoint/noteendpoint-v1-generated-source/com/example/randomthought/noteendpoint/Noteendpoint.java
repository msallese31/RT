 ...
 * on 2014-07-25 at 19:48:01 UTC 
 * Modify at your own risk.
 */

package com.example.randomthought.noteendpoint;
...
public class Noteendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetNote extends NoteendpointRequest<com.example.randomthought.noteendpoint.model.Note> {
    ...
    protected GetNote(java.lang.String id) {
      super(Noteendpoint.this, "GET", REST_PATH, null, com.example.randomthought.noteendpoint.model.Note.class);
   ...
   *
   * @param content the {@link com.example.randomthought.noteendpoint.model.Note}
   * @return the request
   */
  public InsertNote insertNote(com.example.randomthought.noteendpoint.model.Note content) throws java.io.IOException {
    InsertNote result = new InsertNote(content);
    initialize(result);
    return result;
  }

  public class InsertNote extends NoteendpointRequest<com.example.randomthought.noteendpoint.model.Note> {
     ...
     * @since 1.13
     */
    protected InsertNote(com.example.randomthought.noteendpoint.model.Note content) {
      super(Noteendpoint.this, "POST", REST_PATH, content, com.example.randomthought.noteendpoint.model.Note.class);
    }
  ...
  public class ListNote extends NoteendpointRequest<com.example.randomthought.noteendpoint.model.CollectionResponseNote> {
     ...
     */
    protected ListNote() {
      super(Noteendpoint.this, "GET", REST_PATH, null, com.example.randomthought.noteendpoint.model.CollectionResponseNote.class);
    }
   ...
   * @return the request
   */
  public UpdateNote updateNote(com.example.randomthought.noteendpoint.model.Note content) throws java.io.IOException {
    UpdateNote result = new UpdateNote(content);
    initialize(result);
    return result;
  }

  public class UpdateNote extends NoteendpointRequest<com.example.randomthought.noteendpoint.model.Note> {
     ...
     * @since 1.13
     */
    protected UpdateNote(com.example.randomthought.noteendpoint.model.Note content) {
      super(Noteendpoint.this, "PUT", REST_PATH, content, com.example.randomthought.noteendpoint.model.Note.class);
    }
